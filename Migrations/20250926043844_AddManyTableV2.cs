...
{
    /// <inheritdoc />
    public partial class AddManyTableV2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SemeterSuggested = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FinalResults", x => x.FinalResultId);
                    table.ForeignKey(
                        name: "FK_FinalResults_Sections_SectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GpaSnapshotId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StudentId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GpaSnapshots", x => x.GpaSnapshotId);
                    table.ForeignKey(
                        name: "FK_GpaSnapshots_Semesters_SemesterId",
                        column: x => x.SemesterId,
                        principalTable: "Semesters",
                        principalColumn: "SemesterId",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_GpaSnapshots_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinalResults_SectionId",
                table: "FinalResults",
                column: "SectionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GpaSnapshots_SemesterId",
                table: "GpaSnapshots",
                column: "SemesterId");

            migrationBuilder.CreateIndex(
                name: "IX_GpaSnapshots_StudentId",
                table: "GpaSnapshots",
                column: "StudentId");
