          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: { xs: 1, sm: 2 } }}>
            <Tooltip title="Trang chủ">
              <Box sx={{ display: "flex", alignItems: "center" }}>
                ...
                <Typography
                  variant="body2"
                  sx={{ ml: 0.5, mr: 1, cursor: "pointer", display: { xs: "none", sm: "block" }, color: theme.palette.text.primary }}
                  onClick={() => navigate("/")}
                >
                  Trang chủ
                </Typography>
              ...
              <Box sx={{ display: "flex", alignItems: "center" }}>
                ...
                >
                  ...
                  <Box sx={{ display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
                    ...
                    <Typography variant="caption" sx={{ color: theme.palette.text.secondary, fontSize: "0.75rem", lineHeight: 1 }}>
                      {getRoleDisplayName()}
                    </Typography>
                  </Box>
                  <ArrowDropDownIcon sx={{ ml: 0.5 }} />
                </Box>
                <Menu anchorEl={anchorEl} open={Boolean(anchorEl)} onClose={handleUserClose} PaperProps={{ sx: { mt: 1, minWidth: 200, "& .MuiMenuItem-root": { px: 2, py: 1 } } }}>
                  ...
                  <MenuItem onClick={() => { navigate(getDashboardByRole()); handleUserClose(); }} sx={{ color: theme.palette.text.primary }}>
                    <DashboardIcon sx={{ mr: 1 }} /> Dashboard
                  </MenuItem>
                  <MenuItem onClick={() => { if (account.role.roleId === 3) { navigate("/student/info"); } else { navigate("/profile"); } handleUserClose(); }} sx={{ color: theme.palette.text.primary }}>
                  ...
                  <Divider />
                  <MenuItem onClick={handleLogout} sx={{ color: theme.palette.error.main, "&:hover": { backgroundColor: theme.palette.error.light + "20" } }}>
              ...
              <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                <Tooltip title="Đăng nhập">
                  <Box sx={{ display: "flex", alignItems: "center" }}>
                    ...
                    <Typography variant="body2" sx={{ ml: 0.5, mr: 1, cursor: "pointer", display: { xs: "none", sm: "block" }, color: theme.palette.text.primary }} onClick={handleLogin}>
                      Đăng nhập
                    </Typography>
                  </Box>
                </Tooltip>
