...
import { Student, Course, Grade, Enrollment } from "~/types/database";
              ...
              <TableRow key={student.student_id}>
                ...
                <TableCell>
                  <Chip
                    ...
                    color={student.student_status === "Active" ? "success" : "default"}
                    size="small"
                  />
                </TableCell>
                ...
                <TableCell>
                  ...
                  <IconButton onClick={() => handleDelete(student.student_id)} size="small">
                    <DeleteIcon />
                  </IconButton>
                </TableCell>
              </TableRow>
            ...
            .map((course) => (
              <TableRow key={course.course_id}>
                ...
                <TableCell>
                  ...
                  <IconButton onClick={() => handleDelete(course.course_id)} size="small">
                    <DeleteIcon />
                  </IconButton>
                </TableCell>
              </TableRow>
      ...
      <Dialog open={openDialog} onClose={handleCloseDialog} maxWidth="md" fullWidth>
        <DialogTitle>
          {editMode ? "Chỉnh sửa" : "Thêm mới"} {
            activeTab === 0 ? "sinh viên" : 
            activeTab === 1 ? "môn học" :
            activeTab === 2 ? "điểm số" : "đăng ký"
          }
        </DialogTitle>
        <DialogContent>
          <Box sx={{ pt: 2 }}>
