    ...
    try {
      ...
      if (response?.success === false) {
        ...
        if (Array.isArray(errData) && errData.length > 0) {
          ...
          toast.error(response?.message || 'Lấy thống kê tổng quan thất bại');
        }
        return null;
      }
      ...
      if (error.response && error.response.data) {
        ...
        toast.error(error.message || 'Lấy thống kê tổng quan thất bại');
      }
      return null;
    }
  },
  ...
  getYearlyGrowth: async (years = 7) => {
    try {
      ...
      if (error.response && error.response.data) {
        ...
        toast.error(error.message || 'Lấy thống kê tăng trưởng thất bại');
      }
      return null;
    }
  },
  ...
  getGraduationYearly: async () => {
    try {
      ...
      if (error.response && error.response.data) {
        ...
        toast.error(error.message || 'Lấy thống kê tốt nghiệp thất bại');
      }
      return null;
    }
  },
  ...
  getStudentGrades: async (mssv) => {
    try {
      ...
      if (error.response && error.response.data) {
        ...
        toast.error(error.message || 'Lấy thống kê điểm sinh viên thất bại');
      }
      return null;
    }
  },
