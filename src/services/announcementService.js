    ...
    try {
      ...
      if (response?.success === false) {
        ...
        if (Array.isArray(errData) && errData.length > 0) {
          ...
          toast.error(response?.message || 'Tạo thông báo thất bại');
        }
        return null;
      }
      ...
      if (error.response && error.response.data) {
        ...
        toast.error(error.message || 'Create announcement failed');
      }
      return null;
    }
  },
  ...
  getAllAnnouncements: async (params = {}) => {
    try {
      ...
      if (error.response && error.response.data) {
        ...
        toast.error(error.message || 'Get announcements failed');
      }
      return null;
    }
  },
    ...
    try {
      ...
      if (response?.success === false) {
        ...
        if (Array.isArray(errData) && errData.length > 0) {
          ...
          toast.error(response?.message || 'Cập nhật thông báo thất bại');
        }
        return null;
      }
      ...
      if (error.response && error.response.data) {
        ...
        toast.error(error.message || 'Update announcement failed');
      }
      return null;
    }
  },
  ...
  deleteAnnouncement: async (id) => {
    try {
      ...
      if (error.response && error.response.data) {
        ...
        toast.error(error.message || 'Delete announcement failed');
      }
      return null;
    }
  },
    ...
    try {
      ...
      if (response?.success === false) {
        ...
        if (Array.isArray(errData) && errData.length > 0) {
          ...
          toast.error(response?.message || 'Lấy thông báo thất bại');
        }
        return null;
      }
      ...
      if (error.response && error.response.data) {
        ...
        toast.error(error.message || 'Get my announcements failed');
      }
      return null;
    }
  },
    ...
    try {
      ...
      if (response?.success === false) {
        ...
        if (Array.isArray(errData) && errData.length > 0) {
          ...
          toast.error(response?.message || 'Lấy chi tiết thông báo thất bại');
        }
        return null;
      }
      ...
      if (error.response && error.response.data) {
        ...
        toast.error(error.message || 'Get announcement detail failed');
      }
      return null;
    }
  },
