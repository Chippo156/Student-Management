  ...
  getFamilyRelationshipsByStudent: async () => {
    try {
      ...
      if (error.response && error.response.data) {
        ...
        toast.error(error.message || 'Lấy quan hệ gia đình thất bại');
      }
      return null;
    }
  },
  ...
  updateFamilyRelationship: async (id, data) => {
    try {
      ...
      if (error.response && error.response.data) {
        ...
        toast.error(error.message || 'Cập nhật quan hệ gia đình thất bại');
      }
      return null;
    }
  },
  createFamilyRelationship: async (data) => {
    try {
      ...
      if (error.response && error.response.data) {
        ...
        toast.error(error.message || 'Thêm quan hệ gia đình thất bại');
      }
      return null;
    }
  },
