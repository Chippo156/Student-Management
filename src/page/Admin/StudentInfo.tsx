...
const StudentInfo: React.FC = () => {
  ...
  const filteredInfos = studentInfos.filter(info => {
    const matchesSearch = info.fullName.toLowerCase().includes(searchTerm.toLowerCase()) ||
                         info.studentId.toLowerCase().includes(searchTerm.toLowerCase()) ||
                         info.email.toLowerCase().includes(searchTerm.toLowerCase());
    const matchesDepartment = !departmentFilter || info.department === departmentFilter;
  ...
  const handleViewInfo = (info: StudentInfo) => {
                  ...
                  <CardContent>
                    ...
                    <List dense>
                      ...
                      <ListItem>
                        ...
                        <ListItemText
                          primary="Ngày sinh"
                          secondary={selectedStudent.birthDate ? new Date(selectedStudent.birthDate).toLocaleDateString('vi-VN') : 'Chưa cập nhật'}
                        />
                      </ListItem>
                      <Divider />
                      <ListItem>
                      ...
                      <List dense>
                        <ListItem>
                          <ListItemText
                            ...
                            secondary={
                              <Chip
                                label={selectedStudent.academicInfo.gpa.toFixed(2)}
                                color={getGPAColor(selectedStudent.academicInfo.gpa) as any}
                                size="small"
                              />
                            }
                          />
                        ...
                        <ListItem>
                          <ListItemText
                            ...
                            secondary={selectedStudent.academicInfo.currentSemester}
                          />
                        </ListItem>
                      </List>
                    )}
