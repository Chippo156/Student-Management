                ...
                <Card>
                  <CardContent>
                    ...
                    <Box display="flex" flexDirection="column" gap={1}>
                      <Typography variant="body2">
                        <strong>Mã sinh viên:</strong> {selectedRecord.studentId}
                      </Typography>
                      <Typography variant="body2">
                        <strong>Học kỳ:</strong> {selectedRecord.semester}
                      </Typography>
                      <Typography variant="body2">
                        <strong>Số tiền:</strong> {formatCurrency(selectedRecord.amount)}
                      </Typography>
                      <Typography variant="body2">
                        <strong>Hạn thanh toán:</strong> {new Date(selectedRecord.dueDate).toLocaleDateString('vi-VN')}
                      </Typography>
                      {selectedRecord.paymentDate && (
                        <Typography variant="body2">
                          <strong>Ngày thanh toán:</strong> {new Date(selectedRecord.paymentDate).toLocaleDateString('vi-VN')}
                        </Typography>
                      )}
                      ...
                      <Typography variant="body2">
                        <strong>Ghi chú:</strong> {selectedRecord.note || 'Không có'}
                      </Typography>
                      <Box mt={1}>
                        <Chip
