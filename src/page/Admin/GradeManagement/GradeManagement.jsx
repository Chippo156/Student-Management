...
function GradeManagement() {
  ...
  const handleSave = () => {
    ...
    if (editingGrade) {
      setGrades(
        grades.map((grade) => (grade.id === editingGrade.id ? newGrade : grade))
      );
  ...
  const columns = [
    ...
    },
    {
      ...
      align: 'center',
      renderCell: (grade) =>
        grade.credits > 0 ? grade.credits.toFixed(1) : '-',
    },
    {
      field: 'midtermScore',
      headerName: 'Điểm GK',
      ...
      align: 'center',
      renderCell: (grade) =>
        grade.midtermScore > 0 ? grade.midtermScore.toFixed(1) : '-',
    },
    {
      field: 'finalScore',
      headerName: 'Điểm CK',
    ...
    },
    {
      ...
      align: 'center',
      renderCell: (grade) =>
        grade.assignmentScore > 0 ? grade.assignmentScore.toFixed(1) : '-',
    },
    {
      field: 'totalScore',
      headerName: 'Điểm TB',
    ...
    },
    {
      ...
      renderCell: (grade) => (
        <Chip
          ...
          sx={{
            fontWeight: 'bold',
            bgcolor: getGradeColor(grade.letterGrade),
            color: 'white',
          }}
        />
      ),
          ...
          <>
            ...
            <Typography variant="body2" color="text.secondary">
              {searchText
                ...
                : 'Chưa có điểm số nào trong hệ thống'}
            </Typography>
          </>
        }
      />
            ...
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    midtermScore: parseFloat(e.target.value),
                  })
                }
            ...
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    finalScore: parseFloat(e.target.value),
                  })
                }
                inputProps={{ min: 0, max: 10, step: 0.1 }}
                size="small"
            ...
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    assignmentScore: parseFloat(e.target.value),
                  })
                }
                inputProps={{ min: 0, max: 10, step: 0.1 }}
                size="small"
