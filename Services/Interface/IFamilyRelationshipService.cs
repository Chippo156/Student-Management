...
namespace StudentManagement.Services.Interface
{
    ...
    {
        Task<FamilyRelationship> CreateFamilyRelationshipAsync(FamilyRelationshipRequest request);
        Task<FamilyRelationship?> UpdateFamilyRelationshipAsync(int familyRelationshipId, FamilyRelationshipRequest request);
